...
namespace CodingChallenge.Data.Classes.Languages
{
    public class Ingles : Idioma
    {
        ...
        public override string Name => "Ingles";

        public override string ShapeName => "shapes";
        ...
        public override string GetEmptyResult() => "Empty list of shapes!";
        ...
        public override string GetPerimeterName() =>"Perimeter";
